    ...
    public partial class UserTask : Form
    {
        ...
        private void FillTasks()
        {
            ...
            try
            {
                ...
                {
                    ds = objTask.Get_DMSUserTasks(((NewCheckboxListItem)(clbUsers.SelectedItem)).Tag.ToString(), CommonData.CompanyCode.ToString());
                    dt = ds.Tables[0];
        ...
        private void GetNodeRecursive(TreeNode treeNode,StringBuilder sbSQL)
        {
            if (treeNode.StateImageIndex == 1 || treeNode.StateImageIndex == 2)
            {
                ...
                {
                    sbSQL.Append("INSERT INTO DMS_USER_TASKS(UT_USER_ID, UT_COMPANY_ID, UT_TASK_LVL1, UT_TASK_LVL2, UT_TASK_LVL3 " +
                            ...
                            ", " + strArrTask[0].ToString() + ", " + strArrTask[1].ToString() + ", " + strArrTask[2].ToString() +
                            ", " + strArrTask[3].ToString() + ", " + strArrTask[4].ToString() + ", " + strArrTask[5].ToString() +
                            ", " + strArrTask[6].ToString() + ", 'E','" + CommonData.LogUserId + "','" + CommonData.CurrentDate + "'); ");
                }
            }
            foreach (TreeNode tn in treeNode.Nodes)
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    objDA = new SQLDB();
                    strSQL = "DELETE FROM DMS_USER_TASKS WHERE UT_USER_ID='" + ((SSAdmin.NewCheckboxListItem)(clbUsers.SelectedItem)).Tag.ToString() + "'";
