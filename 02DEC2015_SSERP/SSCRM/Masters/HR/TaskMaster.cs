...
namespace SSCRM
{
    public partial class TaskMaster : Form
    {
        ...
        private void FillTasks()
        {
            ...
            try
            {
                string strCommand = "SELECT CAST(TM_TASK_LVL1 AS VARCHAR)+'^'+CAST(TM_TASK_LVL2 AS VARCHAR)+'^'+CAST(TM_TASK_LVL3 AS VARCHAR)+'^'+CAST(TM_TASK_LVL4 AS VARCHAR)+'^'+CAST(TM_TASK_LVL5 AS VARCHAR)+'^'+CAST(TM_TASK_LVL6 AS VARCHAR)+'^'+CAST(TM_TASK_LVL7 AS VARCHAR) AS VALUE_MEMBER,TM_LABEL,TM_PROGRAM_NAME FROM TASK_MASTER order by TM_TASK_LVL1,TM_TASK_LVL2,TM_TASK_LVL3,TM_TASK_LVL4,TM_TASK_LVL5,TM_TASK_LVL6,TM_TASK_LVL7";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (CheckData())
            {
                ...
                try
                {
                    ...
                    String strCommand = "INSERT INTO TASK_MASTER(" +
