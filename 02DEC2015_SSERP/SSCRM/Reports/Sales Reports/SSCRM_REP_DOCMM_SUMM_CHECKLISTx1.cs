...
namespace SSCRM.Reports.Sales_Reports {
    ...
    public class SSCRM_REP_DOCMM_SUMM_CHECKLISTx : ReportClass {
        
        public SSCRM_REP_DOCMM_SUMM_CHECKLISTx() {
        }
        
        public override string ResourceName {
            get {
                return "SSCRM_REP_DOCMM_SUMM_CHECKLISTx.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SSCRM.Reports.Sales Reports.SSCRM_REP_DOCMM_SUMM_CHECKLISTx.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSSCRM_REP_DOCMM_SUMM_CHECKLISTx : Component, ICachedReport {
        
        public CachedSSCRM_REP_DOCMM_SUMM_CHECKLISTx() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SSCRM_REP_DOCMM_SUMM_CHECKLISTx rpt = new SSCRM_REP_DOCMM_SUMM_CHECKLISTx();
            rpt.Site = this.Site;
            return rpt;
        }
