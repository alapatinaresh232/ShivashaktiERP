...
namespace SSCRM.Reports.Sales_Reports {
    ...
    public class SSCRM_REP_DOCMM_SUMM_CHECKLIST : ReportClass {
        
        public SSCRM_REP_DOCMM_SUMM_CHECKLIST() {
        }
        
        public override string ResourceName {
            get {
                return "SSCRM_REP_DOCMM_SUMM_CHECKLIST.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SSCRM.Reports.Sales Reports.SSCRM_REP_DOCMM_SUMM_CHECKLIST.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSSCRM_REP_DOCMM_SUMM_CHECKLIST : Component, ICachedReport {
        
        public CachedSSCRM_REP_DOCMM_SUMM_CHECKLIST() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SSCRM_REP_DOCMM_SUMM_CHECKLIST rpt = new SSCRM_REP_DOCMM_SUMM_CHECKLIST();
            rpt.Site = this.Site;
            return rpt;
        }
