...
namespace SSCRM.Reports.StockPoint_Reports {
    ...
    public class SSCRM_REP_STOCKPOINT_DCST : ReportClass {
        
        public SSCRM_REP_STOCKPOINT_DCST() {
        }
        
        public override string ResourceName {
            get {
                return "SSCRM_REP_STOCKPOINT_DCST.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SSCRM.Reports.StockPoint Reports.SSCRM_REP_STOCKPOINT_DCST.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSSCRM_REP_STOCKPOINT_DCST : Component, ICachedReport {
        
        public CachedSSCRM_REP_STOCKPOINT_DCST() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SSCRM_REP_STOCKPOINT_DCST rpt = new SSCRM_REP_STOCKPOINT_DCST();
            rpt.Site = this.Site;
            return rpt;
        }
