...
namespace SSCRM.Reports.StockPoint_Reports {
    ...
    public class SSCRM_REP_STOCKPOINTS_GRN : ReportClass {
        
        public SSCRM_REP_STOCKPOINTS_GRN() {
        }
        
        public override string ResourceName {
            get {
                return "SSCRM_REP_STOCKPOINTS_GRN.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SSCRM.Reports.StockPoint Reports.SSCRM_REP_STOCKPOINTS_GRN.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSSCRM_REP_STOCKPOINTS_GRN : Component, ICachedReport {
        
        public CachedSSCRM_REP_STOCKPOINTS_GRN() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SSCRM_REP_STOCKPOINTS_GRN rpt = new SSCRM_REP_STOCKPOINTS_GRN();
            rpt.Site = this.Site;
            return rpt;
        }
