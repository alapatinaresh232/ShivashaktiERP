...
namespace SSCRM.Reports.StockPoint_Reports {
    ...
    public class SSCRM_REP_STOCKPOINT_DC : ReportClass {
        
        public SSCRM_REP_STOCKPOINT_DC() {
        }
        
        public override string ResourceName {
            get {
                return "SSCRM_REP_STOCKPOINT_DC.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SSCRM.Reports.StockPoint Reports.SSCRM_REP_STOCKPOINT_DC.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSSCRM_REP_STOCKPOINT_DC : Component, ICachedReport {
        
        public CachedSSCRM_REP_STOCKPOINT_DC() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SSCRM_REP_STOCKPOINT_DC rpt = new SSCRM_REP_STOCKPOINT_DC();
            rpt.Site = this.Site;
            return rpt;
        }
