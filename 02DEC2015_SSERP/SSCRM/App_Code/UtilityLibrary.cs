...
namespace SSCRM.App_Code
{
    public class UtilityLibrary
    {
        ...
        public static void AutoCompleteComboBox(ComboBox ComboBoxControl, DataTable dtDataTable, string strSqlText, string FieldName)
        {
            AutoCompleteStringCollection daColl = new AutoCompleteStringCollection();
            string[] postSource = dtDataTable
                    .AsEnumerable()
            ...
            var source = new AutoCompleteStringCollection();
            source.AddRange(postSource);
            ComboBoxControl.AutoCompleteCustomSource = source;
            ComboBoxControl.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
            ComboBoxControl.AutoCompleteSource = AutoCompleteSource.CustomSource;
        }
        #endregion
